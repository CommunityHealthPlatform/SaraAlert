                    ...
                    {crumb['href'] && (
                      <a
                        ...
                        onClick={() => {
                          ...
                          } else if (this.renderWorkflowName(crumb['value']).includes('Global')) {
                            // Public Health "Return to Global Dashboard"
                            location.assign(`${window.BASE_PATH}/public_health/global`);
