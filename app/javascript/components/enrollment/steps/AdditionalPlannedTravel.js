              ...
              <Form.Row>
                <Form.Group as={Col} md="8" controlId="additional_planned_travel_type">
                  ...
                  <Form.Control
                    ...
                    value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_type || ''}
                ...
                <Form.Group as={Col} md="8" controlId="additional_planned_travel_destination">
                  ...
                  <Form.Control
                    ...
                    size="lg"
                    className="form-square"
                    value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_destination || ''}
                    onChange={this.handleChange}
                  />
                  <Form.Control.Feedback className="d-block" type="invalid">
                ...
                {this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_type &&
                  this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_type === 'International' && (
                    <Form.Group as={Col} md="8" controlId="additional_planned_travel_destination_country">
                      ...
                      <Form.Control
                        ...
                        size="lg"
                        className="form-square"
                        value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_destination_country || ''}
                        onChange={this.handleChange}>
                        <option></option>
                ...
                {!(
                  ...
                  <Form.Group as={Col} md="8" controlId="additional_planned_travel_destination_state">
                    ...
                    <Form.Control
                      ...
                      value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_destination_state || ''}
                      onChange={this.handleChange}>
                      <option></option>
              ...
              <Form.Row>
                <Form.Group as={Col} md="8" controlId="additional_planned_travel_port_of_departure">
                  ...
                  <Form.Control
                    ...
                    size="lg"
                    className="form-square"
                    value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_port_of_departure || ''}
                    onChange={this.handleChange}
                  />
                  <Form.Control.Feedback className="d-block" type="invalid">
                ...
                <Form.Group as={Col} md="8" controlId="additional_planned_travel_start_date">
                  ...
                  <DateInput
                    ...
                    date={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_start_date}
                    minDate={'2020-01-01'}
                ...
                <Form.Group as={Col} md="8" controlId="additional_planned_travel_end_date">
                  ...
                  <DateInput
                    ...
                    date={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_end_date}
                    minDate={'2020-01-01'}
                    maxDate={moment().add(30, 'days').format('YYYY-MM-DD')}
              ...
              <Form.Row className="pb-2">
                <Form.Group as={Col} md="24" controlId="additional_planned_travel_related_notes">
                  ...
                  <Form.Control
                    ...
                    value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.additional_planned_travel_related_notes || ''}
                    onChange={this.handleChange}
                  />
                  <Form.Control.Feedback className="d-block" type="invalid">
...
const schema = yup.object().shape({
  additional_planned_travel_type: yup.string().max(200, 'Max length exceeded, please limit to 200 characters.').nullable(),
  additional_planned_travel_destination: yup.string().max(200, 'Max length exceeded, please limit to 200 characters.').nullable(),
  additional_planned_travel_destination_country: yup.string().max(200, 'Max length exceeded, please limit to 200 characters.').nullable(),
  additional_planned_travel_destination_state: yup.string().max(200, 'Max length exceeded, please limit to 200 characters.').nullable(),
  additional_planned_travel_port_of_departure: yup.string().max(200, 'Max length exceeded, please limit to 200 characters.').nullable(),
  ...
  additional_planned_travel_end_date: yup
    ...
    .nullable(),
  additional_planned_travel_related_notes: yup.string().max(2000, 'Max length exceeded, please limit to 2000 characters.').nullable(),
});
