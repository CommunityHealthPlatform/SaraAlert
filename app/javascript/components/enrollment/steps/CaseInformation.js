...
class CaseInformation extends React.Component {
  ...
  handleSymptomOnsetChange = date => {
    ...
    let modified = this.state.modified;
    let currentMonitoringInfo = current.monitoring_infos;
    currentMonitoringInfo[this.props.activeMonitoringInfoIndex]['symptom_onset'] = date;
    let modifiedMonitoringInfo = modified.monitoring_infos;
    modifiedMonitoringInfo[this.props.activeMonitoringInfoIndex]['symptom_onset'] = date;
  ...
  renderIsolationFields = () => {
    return (
      <React.Fragment>
        {!this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.symptom_onset && !this.state.current.first_positive_lab && (
        ...
        <Form.Row>
          <Form.Group as={Col} md={12} xs={24} controlId="symptom_onset" className="mb-2">
            <Form.Label className="input-label">
              SYMPTOM ONSET DATE
              {this.props.currentState.monitoring_infos[this.props.activeMonitoringInfoIndex]?.symptom_onset &&
                this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.symptom_onset && (
                  <div style={{ display: 'inline' }}>
                    <span data-for="user_defined_symptom_onset_tooltip" data-tip="" className="ml-2">
                      {this.props.currentState.monitoring_infos[this.props.activeMonitoringInfoIndex]?.user_defined_symptom_onset ? (
            ...
            <DateInput
              ...
              date={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.symptom_onset}
              minDate={'2020-01-01'}
          ...
          <Form.Group as={Col} md={12} xs={24} controlId="case_status" className="mb-2">
            ...
            <Form.Control
              ...
              value={this.state.current.monitoring_infos[this.props.activeMonitoringInfoIndex]?.case_status || ''}>
              <option></option>
