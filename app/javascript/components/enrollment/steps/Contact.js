          ...
          <Card.Body>
            <Form>
              <Form.Row className="mb-2">
                <Form.Group as={Col} md="12" lg="10" controlId="preferred_contact_method">
                ...
                {(this.state.current.patient.preferred_contact_method === 'SMS Texted Weblink' ||
                  ...
                  <Form.Group as={Col} md="12" lg="10" controlId="preferred_contact_time">
                    <Form.Label className="nav-input-label">
              ...
              <Form.Row>
                <Form.Group as={Col} md="12" lg="10" controlId="primary_telephone">
                ...
                <Form.Group as={Col} md="12" lg="10" controlId="secondary_telephone">
                  <Form.Label className="nav-input-label">
              ...
              <Form.Row>
                <Form.Group as={Col} md="12" lg="10" controlId="primary_telephone_type" className="mb-0">
                ...
                <Form.Group as={Col} md="12" lg="10" controlId="secondary_telephone_type" className="mb-0">
                  <Form.Label className="nav-input-label">
              ...
              <Form.Row className="mt-2">
                <Form.Group as={Col} md="12" lg="10" controlId="email">
                ...
                <Form.Group as={Col} md="12" lg="10" controlId="confirm_email">
