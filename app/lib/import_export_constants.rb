...
module ImportExportConstants # rubocop:todo Metrics/ModuleLength
  ...
  EPI_X_FIELDS = [nil, nil, nil, nil, :last_name, :first_name, :middle_name, :date_of_birth, :gender_identity, nil, nil, nil, :secondary_telephone,
                  :primary_telephone, :address_line_1, :address_city, :address_state, :address_zip, :foreign_address_country, :email, nil, :address_line_2,
                  nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, :flight_or_vessel_number, :date_of_departure, nil, :date_of_arrival,
                  :port_of_entry_into_usa, :user_defined_id_cdc, :symptom_onset, :exposure_notes].freeze
