...
ActiveRecord::Schema.define(version: 2021_10_29_201619) do
  ...
  create_table "assessments", charset: "utf8", force: :cascade do |t|
    ...
    t.bigint "monitoring_info_id"
    t.index ["created_at"], name: "assessments_index_chain_1"
    t.index ["created_at"], name: "assessments_index_chain_3"
    t.index ["monitoring_info_id"], name: "index_assessments_on_monitoring_info_id"
    t.index ["symptomatic", "created_at"], name: "assessments_index_chain_2"
  end
  ...
  create_table "conditions", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["monitoring_program_id"], name: "index_conditions_on_monitoring_program_id"
  ...
  create_table "demographics", charset: "utf8", force: :cascade do |t|
    t.integer "age"
    t.string "assigned_sex"
    t.string "gender"
    t.boolean "black_or_african_american"
    t.boolean "native_hawaiian_or_pacific_islander"
    t.boolean "white"
    t.boolean "asian_or_asian_american"
    t.string "other_race"
    t.string "no_ethnicity_response"
    t.string "sexuality"
    t.string "highest_schooling"
    t.string "combined_income"
    t.string "marital_status"
    t.string "covered_by_health_insurance"
    t.boolean "medicaid"
    t.boolean "private_health_insurance"
    t.boolean "medicaid_plus_supplement"
    t.boolean "military_va"
    t.string "other_health_insurance"
    t.string "no_health_insurance_response"
    t.boolean "english_at_home"
    t.string "other_language_at_home"
    t.string "english_proficency"
    t.bigint "patient_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["patient_id"], name: "index_demographics_on_patient_id"
  end
  ...
  create_table "monitoring_infos", charset: "utf8", force: :cascade do |t|
    t.bigint "patient_id"
    t.bigint "monitoring_program_id"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["monitoring_program_id"], name: "index_monitoring_infos_on_monitoring_program_id"
    t.index ["patient_id"], name: "index_monitoring_infos_on_patient_id"
  end
